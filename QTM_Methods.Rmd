...
africa_popgdp <- read_csv("data/dataverse_files/africa_popgdp.csv") 
...
ggplot(summary_df, aes(x = reorder(CTRY, mean_GDP), y = mean_WECON, fill = mean_GDP)) +
  ...
  theme_minimal()
```
From the visualization, there is no clear indication of any sort of trend/ correlation between the two variables of interests so we pivotted to a linear regression model. 
