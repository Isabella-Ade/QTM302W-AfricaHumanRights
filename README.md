...
## Project Description
* Data:
  - The human rights data draws from the [Cingranelli–Richards (CIRI) Human Rights Dataset](http://www.humanrightsdata.com/) (Version 2014.04.14), which includes annual data for 202 countries from 1994–2014. The dataset measures state respect for human rights based on analyses of the U.S. Department of State Country Reports on Human Rights Practices and Amnesty International documentation. While this dataset includes various indicators, this project focuses on the indicators physical integrity index (PHYSINT), women's economic rights (WECON), and women's poitical rights (WOPOPL).
